...
globalkeys = gears.table.join(
	...
	end, { description = "show firefox", group = "user" }),
	awful.key({ modkey }, "e", function()
		awful.spawn.with_shell("nemo")
	end, { description = "show nemo", group = "user" }),
	awful.key({ modkey }, "a", function()
		awful.spawn.with_shell("flatpak run org.telegram.desktop")
	end, { description = "show nemo", group = "user" }),
	awful.key({ modkey }, "v", function()
		awful.spawn.with_shell(
			"rofi -modi 'clipboard:greenclip print' -show clipboard -run-command '{cmd}' -theme /home/gabriel/.config/rofi/launchers/type-1/style-3.rasi"
		)
	end, { description = "show nemo", group = "user" }),
	-- Layout manipulation
	...
	awful.key({ modkey, "Shift" }, "q", function()
		awful.util.spawn("/home/gabriel/.config/rofi/powermenu/type-1/powermenu.sh")
	end, { description = "open logout", group = "awesome" }),
	...
	awful.key({ modkey }, "space", function()
		awful.util.spawn("rofi -show drun -theme /home/gabriel/.config/rofi/launchers/type-2/style-2.rasi")
	end, { description = "show the menubar", group = "launcher" }),

	--Lock
	awful.key({ modkey }, "l", function()
		awful.util.spawn("i3lock -i '/home/gabriel/Imagens/lock.png'")
	end, { description = "lock", group = "user" })
)
...
clientkeys = gears.table.join(
	...
	end, { description = "pin window", group = "client" }),
