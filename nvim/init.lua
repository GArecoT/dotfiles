...
require('packer').startup(function(use)
  ...
  use {
    "SmiteshP/nvim-navbuddy", --ajuda navegação
    requires = {
  ...
  use({
    "https://git.sr.ht/~whynothugo/lsp_lines.nvim", --lnhas bonitinhas pra LSP
    config = function()
  ...
  vim.o.shell = "/bin/fish"                 --fish como terminal
...
vim.keymap.set('n', "<C-;>", "<Cmd>Navbuddy<Cr>", { silent = true })
